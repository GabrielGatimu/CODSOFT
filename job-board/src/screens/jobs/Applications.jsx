...
function Applications() {
    ...
    const [getApplications, {isLoading: getApplicationsLoading, error: getApplicationsError}] = useGetMyApplicationsMutation()
    ...
    return (
        <div>
            <h1 className="font-bold p-1 mb-2 md:mb-6 w-full text-stone-900 text-xl md:text-2xl leading-4 flex justify-center">Applied jobs</h1>
            <div
